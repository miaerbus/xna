        ...
        void update(float dt)
        {
            ...
            if (frame > 1)
            {
                ...
                if (power > 0)
                {
                    ...
                    {
                        Bomberman.CurrentLevel.Scene.Add(new Explosion(p + Vector3.Left * Bomberman.GridSize, Vector3.Left, power - 1));
                        Bomberman.CurrentLevel.Scene.Add(new Explosion(p + Vector3.Right * Bomberman.GridSize, Vector3.Right, power - 1));
                        Bomberman.CurrentLevel.Scene.Add(new Explosion(p + Vector3.Forward * Bomberman.GridSize, Vector3.Forward, power - 1));
                        Bomberman.CurrentLevel.Scene.Add(new Explosion(p + Vector3.Backward * Bomberman.GridSize, Vector3.Backward, power - 1));
                    }
                    else
                    {
                        Bomberman.CurrentLevel.Scene.Add(new Explosion(p + direction * Bomberman.GridSize, direction, power - 1));
                    }
                }
            }
        }
