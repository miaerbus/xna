...
namespace Artificial.XNATutorial.Bomberman
{
    public class Options : Part
    {
        ...
        public override void Install(Item parent)
        {
            ...
            // Prepare scene
            menu.Scene.Add(new TextButton(new Vector3(400, 0, 50), "OPTIONS", menu.Font,null));
            menu.Scene.Add(new TextButton(new Vector3(400, 0, 275), Bomberman.Game.Graphics.IsFullScreen ? "WINDOWED" : "FULLSCREEN", menu.Font, Fullscreen));
            menu.Scene.Add(new TextButton(new Vector3(400, 0, 325), "BACK", menu.Font, Back));
        }
