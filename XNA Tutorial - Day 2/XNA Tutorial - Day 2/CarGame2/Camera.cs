...
namespace Artificial.XNATutorial.CarGame
{
    public class Camera
    {
        ...
        // Bounding frustum
        // Frustum is a portion of pyramide, cut between two planes. Well, well, well,
        // if our view 'cone' is this pyramide, the near and far planes are cutting a
        // portion of it. That's our camera's frustum - a volume in our 3D space that the
        // camera sees from its position.
        ...
        // UPDATING
        // We cache the calculated matrices and frustum and update only when the
        // camera or target position change
        ...
        {
            // Frustum in world space coordinates is calcualated from view and projection matrices
