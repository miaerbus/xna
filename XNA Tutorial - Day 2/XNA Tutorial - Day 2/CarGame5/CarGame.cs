...
{
    /// <summary>
    /// XNA TUTORIAL - CAR GAME PART 5
    /// 
    /// We add a new ABT renderer to visually see what's going on in our ABTs
    /// </summary>
    public class CarGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            this.Window.Title = "XNA Tutorial - Car Game Part 5";
            ...
            for (int i = 0; i < numBuildings; i++)
            {
                ...
                //b.Position = new Vector3((i-numBuildings/2)/(numBuildings/buildingsGrid/2) * 20 + 10, random.Next(-buildingsGrid, buildingsGrid) * 20 + 10, 0);
