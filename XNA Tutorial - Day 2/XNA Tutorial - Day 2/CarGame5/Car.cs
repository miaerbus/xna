...
{
    class Car : IPosition, IWorldMatrix
    {
        // Direction
        ...
        public Vector3 Position
        {
            ...
            set
            {
                position = value;
                updateWorldMatrix();
                RaiseOnPositionChanged(position);
            }
        }
        ...
        private void RaiseOnPositionChanged(Vector3 position)
        {
            EventHandler<PositionEventArgs> e = OnPositionChanged;
            if (e != null) e(this, new PositionEventArgs(position));
        }
